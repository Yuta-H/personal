...
class TroublesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trouble" do
    assert_difference('Trouble.count') do
      post troubles_url, params: { trouble: { reference: @trouble.reference, solution: @trouble.solution, user_id: @trouble.user_id } }
    end
  ...
  test "should update trouble" do
    patch trouble_url(@trouble), params: { trouble: { reference: @trouble.reference, solution: @trouble.solution, user_id: @trouble.user_id } }
