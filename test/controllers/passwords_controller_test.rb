...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { password: @password.password, secret_id: @password.secret_id, user_id: @password.user_id } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { password: @password.password, secret_id: @password.secret_id, user_id: @password.user_id } }
